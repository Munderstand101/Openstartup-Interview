...
class AnnoncesController extends AbstractController
{
     ...
     */
    public function show(Ensemble $annonce): Response
    {
     ...
     */
    public function edit(Request $request, Ensemble $annonce,ManagerRegistry $doctrine): Response
    {
        $form = $this->createForm(AnnoncesType::class, $annonce);
        $form->handleRequest($request);
    ...
    /**
     * @Route("/{id}", name="annonces_delete", methods={"POST","DELETE"})
     */
    public function delete(Request $request, Ensemble $annonce,ManagerRegistry $doctrine): Response
    {
